  ...
  const team = [
    {
      ...
      description: language === "en" 
        ? "AI and strategy expert, Amine leads our company vision with over 10 years of experience in the technology field."
        : "Expert en IA et stratégie, Amine dirige notre vision d'entreprise avec plus de 10 ans d'expérience dans le domaine technologique."
    },
    {
      name: "Yousra",
      title: language === "en" ? "CLO & Co-Founder" : "CLO & Co-Founder",
      image: "/lovable-uploads/7277b1f7-9b0a-4000-8aa0-3b39772c463d.png",
      description: language === "en"
        ? "Specialist in ethical AI and digital rights, Yousra ensures our solutions meet the strictest legal and ethical standards."
        : "Spécialiste en IA éthique et droits numériques, Yousra assure que nos solutions respectent les normes légales et éthiques les plus strictes."
    },
    {
      name: "Yohan",
      ...
      description: language === "en"
        ? "With a strong background in mathematics and data science, Yohan leads our analysis and machine learning projects."
    ...
    },
    {
      ...
      description: language === "en"
        ? "Marie guides our clients throughout their journey, ensuring successful adoption of our AI solutions."
    ...
    },
    {
      ...
      description: language === "en"
        ? "Digital marketing expert, Imane develops innovative strategies to optimize our online presence and attract new clients."
